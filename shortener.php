<?php
/**
 * This is an example file of how you can utilise http://qttr.at/yourls-api.php
 * URL shortener service from a GNUSocial instance, which is using https.
 * If you run the qvitter code «as is» the browser will stop you from
 * communicating to qttr.at which is currently running http protocol.
